        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Update</strong><small> Profile Picture</small></div>
                            ...
                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="../assets/img/profile/<?php echo $row['profilePic'];?>" width="100" height="100">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <p style="text-align: center;">
                                    <button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit"> <i class="fa fa-dot-circle-o"></i> Update Picture</button>
                                </p>
    ...
    <?php 
        if(isset($_POST['submit']))
        {
            ...
            else
            {
                ...
                move_uploaded_file($_FILES["newpic"]["tmp_name"],"../assets/img/profile/".$propic);
                $sql = "update staff set profilePic='$propic' where id='$eid'";
                $query = mysqli_query($con, $sql);
